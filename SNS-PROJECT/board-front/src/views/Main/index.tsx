...
export default function Main() {
  ...
  const MainBottom = () => {
    ...
    //    state: 최신 게시물 상태(임시)    //
    const [currnetBoardList, setCurrentBoardList] = useState<BoardListItem[]>([]);
      ...
      <div id='main-bottom-wrapper'>
        ...
        <div className='main-bottom-contents-box'>
          <div className='main-bottom-current-contents'>
            {currnetBoardList.map(boardListItem => <BoardItem boardListItem={boardListItem}/>)}
          </div>
